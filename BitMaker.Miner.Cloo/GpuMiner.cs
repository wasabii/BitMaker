        ...
        private unsafe void Work(Work work)
        {
            ...
            using (var output1Buffer = new ComputeBuffer<uint>(clContext, ComputeMemoryFlags.WriteOnly, 16))
            {
                ...
                while (true)
                {
                    ...
                    // precompute as much of block 2 state as possible
                    ...
                    {
                        uint* round1Block2Ptr = (uint*)(round1BlocksPtr + Sha256.SHA256_BLOCK_SIZE);
                        Sha256.Round(ref round1State2Pre[0], ref round1State2Pre[1], ref round1State2Pre[2], ref round1State2Pre[3], ref round1State2Pre[4], ref round1State2Pre[5], ref round1State2Pre[6], ref round1State2Pre[7], round1Block2Ptr, 0);
                        Sha256.Round(ref round1State2Pre[0], ref round1State2Pre[1], ref round1State2Pre[2], ref round1State2Pre[3], ref round1State2Pre[4], ref round1State2Pre[5], ref round1State2Pre[6], ref round1State2Pre[7], round1Block2Ptr, 1);
                        Sha256.Round(ref round1State2Pre[0], ref round1State2Pre[1], ref round1State2Pre[2], ref round1State2Pre[3], ref round1State2Pre[4], ref round1State2Pre[5], ref round1State2Pre[6], ref round1State2Pre[7], round1Block2Ptr, 2);

                        W2 = ((uint*)round1BlocksPtr)[18];
                        W16 = ((uint*)round1BlocksPtr)[16] + (Sha256.Rotr(((uint*)round1BlocksPtr)[17], 7) ^ Sha256.Rotr(((uint*)round1BlocksPtr)[17], 18) ^ (((uint*)round1BlocksPtr)[17] >> 3));
                        W17 = ((uint*)round1BlocksPtr)[17] + (Sha256.Rotr(((uint*)round1BlocksPtr)[18], 7) ^ Sha256.Rotr(((uint*)round1BlocksPtr)[18], 18) ^ (((uint*)round1BlocksPtr)[18] >> 3)) + 0x01100000;
