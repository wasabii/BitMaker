...
namespace BitMaker.Miner.Plugin.Cpu
{
    ...
    public static class Sha256
    {
        ...
        /// <summary>
        /// Initializes <paramref name="output"/> with the SHA-256 initial state. Ensure <paramref name="output"/> is
        /// 32 bytes in length.
        /// </summary>
        /// <param name="output"></param>
        public static unsafe void Init(byte* output)
        {
            // initialize state with init value
            fixed (uint* _h = h)
                BitUtil.Copy(_h, output, 0, 32);
        }

        /// <summary>
        /// Updates the hash state <paramref name="state"/> with the given input buffer. Ensure <paramref
        /// name="state"/> and <paramref name="input"/> are both 32 bytes in length.
        /// </summary>
        public static unsafe void Transform(byte* state, byte* input)
        {
